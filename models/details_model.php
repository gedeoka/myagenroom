...
class Details_Model extends Model{
    ...
    public function hList(){
        ...
        $sql="SELECT profile.ProfileID, Min(roomprice.Normal) AS price,roomprice.RoomID, profile.Name, profile.Address, country.CountryName, area.AreaName, profile.Star, province.ProvinceName
...
GROUP BY profile.ProfileID, profile.Star, profile.Name, profile.Address, country.CountryName, area.AreaName, profile.Star, province.ProvinceName
ORDER BY Min(roomprice.Normal) DESC;";
    ...
    public function data($id){
        $sql="SELECT profile.Address, profile.Phone, profile.Fax, profile.Star, country.CountryName, province.ProvinceName, area.AreaName, profile.Deskripsi, profile.CheckIn, profile.CheckOut, profile.LatMap, profile.LongMap, profile.ProfileID
