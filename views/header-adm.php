                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        ...
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                <li><a href="<?php echo URL;?>index"><i class="fa fa-home"></i> Home</a></li>
                                <li><a><i class="fa fa-windows"></i> Master Data <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu" style="display: none">
                                        <li><a href="<?php echo URL;?>msuser">User's</a>
                                        </li>
                                        <li><a href="<?php echo URL;?>mspartner">Partner(Hotel's/Villa's)</a>
                                        </li>
                                        <li><a href="<?php echo URL;?>msagent">Agent</a>
                                        </li>
                                        <li><a href="<?php echo URL;?>mscountry">Country</a>
                                        </li>
                                        <li><a href="<?php echo URL;?>msprovence">Province</a>
                                        </li>
                                        <li><a href="<?php echo URL;?>msarea">Area</a>
                                        </li>
                                    </ul>
                                </li>
                                 <li><a><i class="fa fa-laptop"></i> Transaction </a>
                                </li>
                                <li><a><i class="fa fa-edit"></i> Message </a></li>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="">
                                ...
                                <ul class="dropdown-menu dropdown-usermenu animated fadeInDown pull-right">
                                    <li><a href="<?php echo URL;?>profile">  Profile</a>
                                    </li>
                                    
                                   
                                    <li><a href="<?php echo URL;?>addashboard/logout"><i class="fa fa-sign-out pull-right"></i> Log Out</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
