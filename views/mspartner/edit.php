        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <form id="demo-form2" data-parsley-validate="" action="<?php echo URL; ?>mspartner/saveEdit/<?php echo $this->msuListSingle['userID'];?>" class="form-horizontal form-label-left" novalidate="" method="POST">
