        ...
        <div class="col-md-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <tbody>
                         <?php
                        foreach ($this->ProdList as $key => $value) {
                            ?>
                        <tr class="even pointer">                            
                            ...
                            <td class=" last"><a href="<?php echo URL;?>mspartner/setprice/<?php echo $value['ProfileID']; ?>-<?php echo $value['RoomID']; ?>">Set Price</a></td>
                            <td class=" last"><a href="<?php echo URL;?>mspartner/editroom/<?php echo $value['ProfileID']; ?>-<?php echo $value['RoomID']; ?>">Edit</a></td>
                            <td class=" "><?php 
                                                switch($value['status']){ 
                                                    case 0:
                                                        echo 'void';
