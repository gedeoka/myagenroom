...
<div class="right_col" role="main">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>Daftar User  <small> [ <a href="<?php echo URL;?>msuser/add">Add New</a> ]</small></h2>
                <div class="clearfix"></div>
            </div>
            <div class="x_content">
                <table class="table table-striped responsive-utilities jambo_table bulk_action">
                    ...
                    <tbody>
                        ...
                        <tr class="even pointer">                            
                            ...
                            <td class=" "><a href='<?php echo URL;?>msuser/edit/<?php echo $value['userID']; ?>'> Edit </a></td>
                            <td class=" last"><a href="<?php echo URL;?>msuser/void/<?php echo $value['userID']; ?>">Void</a>
                            </td>
                        </tr>
                        <?php } ?>
