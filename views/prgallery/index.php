            ...
            <div class="x_panel">
                <div class="x_title">
                    <h2>List Image</h2><br><br>
                        <p>[ <a href="<?php echo URL;?>prprofile/">back</a> ]</p>
                ...
                <div class="x_content">
                    <div class="row">
                        <?php
                        foreach ($this->pGalList as $key => $value){
                        ?>
...
$('.del').click(function(){
    ...
    //alert(gid + " = " + prid);
    $.post("prgallery/pdelgal",{"gid":gid,"prid":prid},function(x){
        //alert(x);
       delItem.remove();
    });
    return false;
