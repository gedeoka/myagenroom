						...
						<div class="list-item box">		
							...
							<div class="block">
								<p class="ratings <?php 
                                                                ...
                                                                ?>"></p>
                                                                <p class="title"><a href="<?php echo URL."ina/details/?detail=".$value["Name"]."`".$in."`".$out."`".$value["ProfileID"]."`".$roomid;?>"><?php echo $value["Name"];?></a></p>
									...
									<?php 
                                                        ...
                                                        <div class="bottom">
                                                            <span class="large-price"><small>From <br><span style="text-decoration:line-through;"><?php echo number_format($Rate);?> IDR</span></small><br>IDR<br> <?php echo number_format($value["price"]);?> </span>
                                                                <a href="<?php echo URL."ina/details/?detail=".$value["Name"]."`".$in."`".$out."`".$value["ProfileID"]."`".$roomid;?>" class="link">Details</a>
                                                        </div>
						</div>
